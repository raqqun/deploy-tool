        ...
        success: function (response) {
            if(action == 'pull') {
                ...
                for(log in pull.gitlog) {
                    ...
                    $('.gitlog tbody').append("<tr class='"+pull.gitlog[log].hash+"'><td>"+pull.gitlog[log].author+"</td><td>"+pull.gitlog[log].date+"</td><td>"+pull.gitlog[log].dater+"</td><td>"+jQuery.substring(pull.gitlog[log].hash, 0, 9)+" "+pull.gitlog[log].message+"</td></tr>");
                }
            }
