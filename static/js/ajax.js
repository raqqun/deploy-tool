        ...
        success: function (response) {
            if(action == 'pull') {
                ...
                for(log in pull.gitlog) {
                    ...
                    $('.gitlog tbody').append("<tr class='"+pull.gitlog[log].hash+"'><td>"+pull.gitlog[log].author+"</td><td>"+pull.gitlog[log].date+"</td><td>"+pull.gitlog[log].dater+"</td><td><a href='http://gitlab.thebeautyst.org/thebeautyst/thebeautyst/commit/"+pull.gitlog[log].hash+"' target='_blank'>"+pull.gitlog[log].hash.substring(0, 9)+"</a> "+pull.gitlog[log].message.replace(/#([0-9]*)/, "<a href='http://redmine.thebeautyst.org/issues/$1' target='_blank'>#$1</a>")+"</td></tr>");
                }
            }
